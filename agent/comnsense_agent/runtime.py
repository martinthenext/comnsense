...
class Ready:
    ...
    def next(self, context, msg):
        if msg.is_event():
            ...
            json_to_send = """{"type" : 0, "workbook" : "f1f2d913-8de3-49b6-8993-f6b026686cda", "sheet": "\xd0\xb2\xd0\xb0\xd1\x81\xd0\xb8\xd0\xbb\xd0\xb8\xd0\xb9", "cells":[[{"key":"$A$1","value":"33", "color":3}]]}"""
